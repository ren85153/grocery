package com.ribuluo.gateway.component.handler;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.ribuluo.common.constant.CommonConstant;
import com.ribuluo.common.util.R;
import com.ribuluo.common.util.exception.JxDeniedException;
...
public class JxAccessDeniedHandler extends OAuth2AccessDeniedHandler {
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException authException) throws IOException, ServletException {
        ...
        R<String> result = new R<>(new JxDeniedException("授权失败，禁止访问"));
