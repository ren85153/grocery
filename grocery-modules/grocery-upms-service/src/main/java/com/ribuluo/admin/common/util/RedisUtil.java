...
public class RedisUtil {
    ...
    public Object leftListPop(String key) {
        return redisTemplate.opsForList().leftPop(key);
    }

    public Object rightListPop(String key) {
    ...
    public  <T> void setListValue(String key, T t) {
        ValueOperations<String, Object> valueOps = redisTemplate.opsForValue();
        valueOps.set(key, t);
    }

    public  <T> T getValueWithT( String key){
        ValueOperations<String, Object> valueOps = redisTemplate.opsForValue();
     ...
     * @param key
     */
    public   void  expireByOneDay(String key) {
