 ...
 * FileName: MapAndBeanConver
 * Author:   weiyz
 * Date:     2019/1/29 22:31
 * Description: map和实体类转换
 * History:
 ...
 * @since 1.0.0
 */
public class MapAndBeanConverUtils {

    private static Logger logger = LoggerFactory.getLogger(MapAndBeanConverUtils.class);
